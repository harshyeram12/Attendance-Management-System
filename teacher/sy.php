...
<html lang = "eng">
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<br />
			<div class = "alert alert-info"><a href="atex_sy.php">Export</a></div>
			<div class = "alert alert-info"><a href="third.php">TY</a></div>
			<div class = "alert alert-info"><a href="sy.php">SY</a></div>
			<div class = "alert alert-info"><a href="fy.php">FY</a></div>
			...
			<div class = "well col-lg-12">
				<table id = "table" class = "table table-bordered">
                  ...
                  $tname=$_SESSION['teacher_name'];
						$q_time = $conn->query("SELECT * FROM `time` where course='SYCO' and teacher='$tname'") or die(mysqli_error());
					...
					?>	
						<tr>
							...
							<td><?php echo date("h:i a", strtotime($f_time['stime']))?></td>
							<td><?php echo date("m-d-Y", strtotime($f_time['sdate']))?></td>
